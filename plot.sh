...
python plot.py -z scatter -d $datafile -xc "idx" -yc "address" -of png -o $plotdir/layout-zoomed11.png -t "Memory layout" --xmin 49800 --xmax 50500 --ymin 2.4564e10 --ymax 2.4574e10
display $plotdir/layout-zoomed11.png &
# python plot.py -z scatter -d $datafile -xc "idx" -yc "address" -of png -o $plotdir/layout-zoomed21.png -t "Memory layout" --xmin 50000 --xmax 51000 --ymin 2.5079e10 --ymax 2.5085e10
